...
public class ValidationReader implements ItemReader, BonusPayoutConstants {
    ...
    @Inject
    @BatchProperty(name = "generateFileNameRoot")
    protected String generateFileNameRootStr;
    ...
    private void setupFileReader() throws Exception {
        BonusPayoutUtils helper = new BonusPayoutUtils(getJobContext(), getGenerateFileNameRoot());
    ...
    protected String getGenerateFileNameRoot() {
        return generateFileNameRootStr;
    }
